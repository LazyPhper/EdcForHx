<?php
return array (
  'ADMIN_CENTER_ADD' => '添加中心',
  'ADMIN_CENTER_ADDPOST' => '添加中心提交数据',
  'ADMIN_CENTER_DEFAULT' => '中心管理',
  'ADMIN_CENTER_DELETE' => '删除中心',
  'ADMIN_CENTER_EDIT' => '编辑中心信息',
  'ADMIN_CENTER_EDITPOST' => '编辑中心数据提交',
  'ADMIN_CENTER_INDEX' => '中心列表',
  'ADMIN_CENTER_UPSTATUS' => '更新中心状态',
  'ADMIN_CHECK_INDEX' => ' 研究项目稽查记录',
  'ADMIN_DOWN_DOWN' => '将数据库数据导出为excel文件',
  ...
  'ADMIN_PROJECT_ADDPOST' => '插入数据库项目内容',
  'ADMIN_PROJECT_ADDRULE' => '规则提交',
  'ADMIN_PROJECT_DEFAULT' => '研究项目中心',
  'ADMIN_PROJECT_EDCADD' => '添加项目crf',
  'ADMIN_PROJECT_EDCADDPOST' => '项目crf 存储',
  'ADMIN_PROJECT_EDCEDIT' => 'crf页面编辑',
  'ADMIN_PROJECT_EDCEDITPOST' => 'crf编辑提交',
  'ADMIN_PROJECT_EDIT' => '编辑项目信息',
  'ADMIN_PROJECT_EDITPOST' => '编辑项目信息 提交',
  'ADMIN_PROJECT_INDEX' => '研究项目',
  'ADMIN_PROJECT_PROJECT_CRF' => '查看crf页面',
  'ADMIN_PROJECT_RULEEDIT' => '规则编辑',
  ...
  'ADMIN_USER_ADDUSERPOST' => '提交增加受试者',
  'ADMIN_USER_ASKPOST' => '疑问插入',
  'ADMIN_USER_BAN' => '停用管理员',
  'ADMIN_USER_CANCELBAN' => '启用管理员',
  'ADMIN_USER_CHECK_USER_CRF' => '审查受试者数据',
  'ADMIN_USER_CRFPOST' => '录入受试者数据',
  'ADMIN_USER_DEFAULT' => '管理组',
  'ADMIN_USER_DELETE' => '管理员删除',
  'ADMIN_USER_DOSIGN' => '对受试者数据进行签名',
  'ADMIN_USER_EDIT' => '管理员编辑',
  'ADMIN_USER_EDITPOST' => '管理员编辑提交',
  'ADMIN_USER_EDITUSERPOST' => '编辑受试者',
  'ADMIN_USER_GROUPADDPOST' => '分组提交数据',
  'ADMIN_USER_GROUPEDITPOST' => '分组编辑提交数据',
  'ADMIN_USER_GROUP_ADD' => '添加分组',
  'ADMIN_USER_GROUP_EDIT' => '编辑分组',
  'ADMIN_USER_INDEX' => '管理员',
  'ADMIN_USER_SIGN' => '签名页面',
  'ADMIN_USER_UPDATEUSERSTATUS' => '更新受试者状态',
  'ADMIN_USER_USERINFO' => '个人信息',
  'ADMIN_USER_USERINFOPOST' => '管理员个人信息修改提交',
  'ADMIN_USER_USER_ADD' => '增加受试者页面',
  'ADMIN_USER_USER_ASK' => '疑问页面',
  'ADMIN_USER_USER_CRF' => '查看用户crf',
  'ADMIN_USER_USER_EDIT' => '编辑受试者页面',
