<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:54:"themes/admin_simpleboot3/portal\admin_article\add.html";i:1535858921;s:72:"G:\PHPTutorial\WWW\hx\public\themes\admin_simpleboot3\public\header.html";i:1535858921;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form action="<?php echo url('AdminArticle/addPost'); ?>" method="post" class="form-horizontal js-ajax-form margin-top-20">
        <div class="row">
            <div class="col-md-9">
                ...
                <?php 
    \think\Hook::listen('portal_admin_article_edit_view_main',$temp5bd2ef0d2e651,null,false);
 ?>
            ...
            <div class="col-md-3">
                        ...
                        <td>
                            <div style="text-align: center;">
                                ...
                                <a href="javascript:uploadOneImage('图片上传','#thumbnail');">
                                    <img src="/hx/public/themes/admin_simpleboot3/public/assets/images/default-thumbnail.png"
                ...
                <?php 
    \think\Hook::listen('portal_admin_article_edit_view_right_sidebar',$temp5bd2ef0d2e66a,null,false);
 ?>
            </div>
        </div>
    </form>
</div>
<script type="text/javascript" src="/hx/public/static/js/admin.js"></script>
<script type="text/javascript">
    //编辑器路径定义
    var editorURL = GV.WEB_ROOT;
</script>
<script type="text/javascript" src="/hx/public/static/js/ueditor/ueditor.config.js"></script>
<script type="text/javascript" src="/hx/public/static/js/ueditor/ueditor.all.min.js"></script>
<script type="text/javascript">
    $(function () {
        ...
        $('.btn-cancel-thumbnail').click(function () {
            $('#thumbnail-preview').attr('src', '/hx/public/themes/admin_simpleboot3/public/assets/images/default-thumbnail.png');
            $('#thumbnail').val('');
        });
