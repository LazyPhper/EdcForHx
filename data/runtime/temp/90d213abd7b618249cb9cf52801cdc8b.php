<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"themes/admin_simpleboot3/admin\project\add.html";i:1540978872;s:72:"G:\PHPTutorial\WWW\hx\public\themes\admin_simpleboot3\public\header.html";i:1540550792;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap js-check-wrap">
		...
		<form action="<?php echo url('project/addPost'); ?>" method="post" class="form-horizontal js-ajax-form margin-top-20">
        <div class="row">
            <div class="col-md-7">
                ...
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td>
                            <input class="form-control" type="text" name="post[project_sn]"
                                   id="project_sn" required value="" placeholder="请输入项目编号"/>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input class="form-control" type="text" name="post[project_name]"
                                   id="project_name" required value="" placeholder="请输入项目名称"/>
                        </td>
                    </tr>
                    ...
                    <tr>
                     ...
                     <tr>
                        <th>合作者</th>
                        <td>
                            <input class="form-control" type="text" name="post[partner]"  value=""
                                   placeholder="请输入合作者">
                        ...
                        <td>
                             <select class="form-control" name="post[project_student]" >
								 <?php if(is_array($admin_y) || $admin_y instanceof \think\Collection || $admin_y instanceof \think\Paginator): if( count($admin_y)==0 ) : echo "" ;else: foreach($admin_y as $key=>$vv): ?>
									 <option value="<?php echo $vv['id']; ?>"><?php echo $vv['user_login']; ?></option>
	                ...
	                <table class="table table-bordered">
	                   <tr>
	                     ...
	                     <tr>
	                        <th>关键字</th>
	                        <td>
	                            <input class="form-control" type="text" name="condition[project_keywords]"  value=""
	                                   placeholder="请输入关键字">
	                     ...
	                     <tr>
	                        <th>合格的标准</th>
	                        <td>
	                            <textarea class="form-control" type="text" name="condition[project_standard]"></textarea>
	                     ...
	                     <tr>
	                        <th>最小年龄</th>
	                        <td>
	                            <input class="form-control" type="text" name="condition[min_age]"  value=""
	                                   placeholder="最小年龄">
	                     ...
	                     <tr>
	                        <th>最大年龄</th>
	                        <td>
	                            <input class="form-control" type="text" name="condition[max_age]"  value=""
	                                   placeholder="最大年龄">
	                    ...
	                    <tr>
	                        <th>接受健康志愿者</th>
	                        <td>
	                            <input class="form-control" type="text" name="condition[project_receive]"  value=""
	                                   placeholder="接受健康志愿者">
	                    ...
	                    <tr>
	                        ...
	                        <td>
	                            <input class="form-control" type="text" name="condition[project_people_num]" required  value=""
	                                   placeholder="预期入组人数">
      		...
      		<div id='project-device' style='display: none'>
	                <table class="table table-bordered">
	                    <tr>
	                        <th>设备名称</th>
	                        <td>
	                            <input class="form-control" type="text" name="device[device_name]"  value=""
	                                   placeholder="设备名称">
	                    ...
	                    <tr>
	                        <th>设备城市</th>
	                        <td>
	                            <input class="form-control" type="text" name="device[device_city]"  value=""
	                                   placeholder="设备城市">
	                    ...
	                    <tr>
	                        <th>设备 州/省</th>
	                        <td>
	                            <input class="form-control" type="text" name="device[device_province]"  value=""
	                                   placeholder="设备 州/省">
	                     ...
	                     <tr>
	                        <th>邮政编码</th>
	                        <td>
	                            <input class="form-control" type="text" name="device[device_postcode]"  value=""
	                                   placeholder="邮政编码">
	                    ...
	                    <tr>
	                        <th>设备国家</th>
	                        <td>
	                            <input class="form-control" type="text" name="device[device_country]"  value=""
	                                   placeholder="设备国家">
	                    ...
	                    <tr>
	                        <th>设备联系姓名</th>
	                        <td>
	                            <input class="form-control" type="text" name="device[device_connet_name]"  value=""
	                                   placeholder="设备联系姓名">
	                     ...
	                     <tr>
	                        <th>设备联系电话</th>
	                        <td>
	                            <input class="form-control" type="text" name="device[device_connet_phone]"  value=""
	                                   placeholder="设备联系电话">
	                     ...
	                     <tr>
	                        <th>设备联系电子邮件</th>
	                        <td>
	                            <input class="form-control" type="text" name="device[device_connet_email]"  value=""
	                ...
	                <table class="table table-bordered">
	                    <tr>
	                        ...
	                        <td>
								  ...
								  <input type="radio" value='1' name="config[config_birthday]" checked id="radio-1" />&nbsp;&nbsp;&nbsp;
								  <label for="radio-2">否</label>
								  <input type="radio" value='2' name="config[config_birthday]" id="radio-2" />&nbsp;&nbsp;&nbsp;
								  <label for="radio-3">出生年份</label>
								  <input type="radio" value='3' name="config[config_birthday]" id="radio-3" />
	                        </td>
	                    </tr>
						<tr>
							<th>性别必须？</th>
							<td>
								...
								<input type="radio" value='1' name="config[config_sex]" id="radio-4" />&nbsp;&nbsp;&nbsp;
								<label for="radio-5">否</label>
								<input type="radio" value='2' name="config[config_sex]" checked id="radio-5" />
							</td>
						</tr>
	                    ...
	                    <tr>
	                        ...
	                        <td>
	                              <label for="radio-4">是</label>
								  <input type="radio" value='1' name="config[config_manage]" checked id="radio-41" />&nbsp;&nbsp;&nbsp;
								  <label for="radio-5">否</label>
								  <input type="radio" value='2' name="config[config_manage]" id="radio-51" />
	                        </td>
	                    </tr>
	                    <tr>
	                        <th>是否需要受试者ID？</th>
	                        <td>
								  ...
								  <input type="radio" value='1' name="config[config_user_id]" checked id="radio-6" />&nbsp;&nbsp;&nbsp;
								  <label for="radio-7">可选</label>
								  <input type="radio" value='2' name="config[config_user_id]" id="radio-7" />
								<label for="radio-71">未使用</label>
								<input type="radio" value='3' name="config[config_user_id]" id="radio-71" />
	                        </td>
	                    </tr>
	                    <tr>
	                        <th>显示ID于CRF页眉？</th>
	                        <td>
								  ...
								  <input type="radio" value='1' name="config[config_id_crf]" id="radio-8" />&nbsp;&nbsp;&nbsp;
								  <label for="radio-9">否</label>
								  <input type="radio" value='2' name="config[config_id_crf]" checked id="radio-9" />
	                        </td>
	                    </tr>
	                    <tr>
	                        ...
	                        <td>
								  ...
								  <input type="radio" value='1' name="config[config_user]" id="radio-10" />
								<label for="radio-101">自动产生并可编辑</label>
								<input type="radio" value='2' name="config[config_user]" id="radio-101" />
								  <label for="radio-11">自动产生并不可编辑</label>
								  <input type="radio" value='3' name="config[config_user]" checked id="radio-11" />
	                        </td>
	                    </tr>
	                    <tr>
	                        ...
	                        <td>
								  ...
								  <input type="radio" value='1' name="config[config_see_user]" checked id="radio-12" />&nbsp;&nbsp;&nbsp;
								  <label for="radio-13">否</label>
								  <input type="radio" value='2' name="config[config_see_user]" id="radio-13" />
	                        </td>
	                    </tr>
	                    <tr>
	                        <th>访视者姓名默认为空？</th>
	                        <td>
								  ...
								  <input type="radio" value='1' name="config[config_see_user_null]" checked id="radio-14" />&nbsp;&nbsp;&nbsp;
								  <label for="radio-15">从实际用户中准备人群化</label>
								  <input type="radio" value='2' name="config[config_see_user_null]" id="radio-15" />
	                        </td>
	                    </tr>
	                    <tr>
	                        <th>访视者姓名是否可以编辑？</th>
	                        <td>
								  ...
								  <input type="radio" value='1' name="config[config_see_user_edit]" checked id="radio-16" />&nbsp;&nbsp;&nbsp;
								  <label for="radio-17">不</label>
								  <input type="radio" value='2' name="config[config_see_user_edit]" id="radio-17" />
	                        </td>
	                    </tr>
	                    <tr>
	                        <th>访视日期是否必需？</th>
	                        <td>
								  ...
								  <input type="radio" value='1' name="config[config_see_time]" checked id="radio-24" />&nbsp;&nbsp;&nbsp;
								  <label for="radio-25">不</label>
								  <input type="radio" value='2' name="config[config_see_time]" id="radio-25" />
	                        </td>
	                    </tr>
	                     <tr>
	                        <th>访视日期默认为空？</th>
	                        <td>
								  ...
								  <input type="radio" value='1' name="config[config_see_time_null]" checked id="radio-18" />&nbsp;&nbsp;&nbsp;
								  <label for="radio-19">不</label>
								  <input type="radio" value='2' name="config[config_see_time_null]" id="radio-19" />
	                        </td>
	                    </tr>
	                     <tr>
	                        <th>访视日期是否可以编辑？</th>
	                        <td>
								  ...
								  <input type="radio" value='1' name="config[config_see_time_edit]" checked id="radio-20" />&nbsp;&nbsp;&nbsp;
								  <label for="radio-21">不</label>
								  <input type="radio" value='2' name="config[config_see_time_edit]" id="radio-21" />
	                        </td>
	                    </tr>
	                     <tr>
	                        <th>管理员编辑强制修改原因？</th>
	                        <td>
								  ...
								  <input type="radio" value='1' name="config[config_admin_edit]" checked id="radio-22" />&nbsp;&nbsp;&nbsp;
								  <label for="radio-23">不</label>
								  <input type="radio" value='2' name="config[config_admin_edit]" id="radio-23" />
	                        </td>
	                    </tr>
	                </table>
          		</div>
