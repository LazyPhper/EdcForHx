...
ThinkCMF免责声明
  ...
  2、您一旦安装使用ThinkCMF，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。</pre>
			...
			<div class="bottom text-center">
				<a href="/EdcForHx/public/?s=install/index/step2" class="btn btn-primary"><?php echo lang('ACCEPT'); ?></a>
			</div>
		</div>
	</div>
	<div class="footer">
