...
<head>
    ...
    <meta charset="utf-8">
    <title>郑州弘新医疗EDC<?php echo lang('ADMIN_CENTER'); ?></title>
    ...
    <link rel="stylesheet" href="/hx/public/themes/admin_simpleboot3/public/assets/themes/<?php echo cmf_get_admin_style(); ?>/simplebootadminindex.min.css">
    <!--[if lt IE 9]>
...
<div class="navbar navbar-default">
    <div class="container-fluid">
        <div class="navbar-header">
            <a href="<?php echo url('admin/index/index'); ?>" class="navbar-brand" style="min-width: 200px;text-align: center;">郑州弘新医疗EDC系统</a>
                ...
                <li class="light-blue dropdown" style="border-left:none;">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <?php if(isset($admin['avatar']) && $admin['avatar']): ?>
                            ...
                            <?php else: ?>
                            <img class="nav-user-photo" width="30" height="30"
                                 src="/hx/public/themes/admin_simpleboot3/public/assets/images/logo-18.png" alt="<?php echo (isset($admin['user_login']) && ($admin['user_login'] !== '')?$admin['user_login']:''); ?>">
                        <?php endif; ?>
...
<script src="/hx/public/themes/admin_simpleboot3/public/assets/simpleboot3/js/adminindex.js"></script>
<script>
    $(function () {
