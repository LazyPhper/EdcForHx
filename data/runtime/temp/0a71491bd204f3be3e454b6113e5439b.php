<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:35:"themes/simpleboot3/user\\login.html";i:1535858921;s:64:"G:\PHPTutorial\WWW\hx\public\themes\simpleboot3\public\head.html";i:1535858921;s:68:"G:\PHPTutorial\WWW\hx\public\themes\simpleboot3\public\function.html";i:1535858921;s:63:"G:\PHPTutorial\WWW\hx\public\themes\simpleboot3\public\nav.html";i:1535858921;s:67:"G:\PHPTutorial\WWW\hx\public\themes\simpleboot3\public\scripts.html";i:1535858921;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<title></title>
...
<![endif]-->
<link rel="icon" href="/hx/public/themes/simpleboot3/public/assets/images/favicon.png" type="image/png">
<link rel="shortcut icon" href="/hx/public/themes/simpleboot3/public/assets/images/favicon.png" type="image/png">
<link href="/hx/public/themes/simpleboot3/public/assets/simpleboot3/themes/simpleboot3/bootstrap.min.css" rel="stylesheet">
<link href="/hx/public/themes/simpleboot3/public/assets/simpleboot3/font-awesome/4.4.0/css/font-awesome.min.css" rel="stylesheet"
      type="text/css">
<!--[if IE 7]>
<link rel="stylesheet" href="/hx/public/themes/simpleboot3/public/assets/simpleboot3/font-awesome/4.4.0/css/font-awesome-ie7.min.css">
<![endif]-->
<link href="/hx/public/themes/simpleboot3/public/assets/css/style.css" rel="stylesheet">
<style>
...
<script src="/hx/public/themes/simpleboot3/public/assets/js/jquery-1.10.2.min.js"></script>
<script src="/hx/public/themes/simpleboot3/public/assets/js/jquery-migrate-1.2.1.js"></script>
...
<body class="body-white">
    ...
    <div class="container active">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/hx/public/"><?php echo (isset($theme_vars['company_name']) && ($theme_vars['company_name'] !== '')?$theme_vars['company_name']:'ThinkCMF'); ?></a>
        </div>
...
function __parse_navigation360572a22e6478352300776442051f4e($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigation360572a22e6478352300776442051f4e';
...
if(''==''): ?>
    <?php echo __parse_navigation360572a22e6478352300776442051f4e($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigation360572a22e6478352300776442051f4e($menus); ?>
    </>
<?php endif; ?>
                ...
                <li class="dropdown user login">
                    <a class="dropdown-toggle user" data-toggle="dropdown" href="#">
                        <?php $user=cmf_get_current_user(); if(empty($user['avatar'])): ?>
                            <img src="/hx/public/themes/simpleboot3/public/assets/images/headicon.png" class="headicon">
                            <?php else: ?>
...
<input type="hidden" name="_captcha_id" value="">
    ...
    <script src="/hx/public/themes/simpleboot3/public/assets/simpleboot3/bootstrap/js/bootstrap.min.js"></script>
    <script src="/hx/public/static/js/frontend.js"></script>
	<script>
	$(function(){
