<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"themes/admin_simpleboot3/admin\project\project_crf.html";i:1540890703;s:72:"G:\PHPTutorial\WWW\hx\public\themes\admin_simpleboot3\public\header.html";i:1540550792;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			...
			<li  ><a href="<?php echo url('project/ruleedit',['project_id'=>$project_id]); ?>">编辑规则</a></li>
		</ul>
								...
								<tr id="crf-<?php echo $v['id']; ?>-tr">
									<?php if(is_array($table['type']) || $table['type'] instanceof \think\Collection || $table['type'] instanceof \think\Paginator): if( count($table['type'])==0 ) : echo "" ;else: foreach($table['type'] as $table_k=>$tab_t): if($tab_t=='text')
										...
										<?php
												...
												?>
												<td class="td_border"><input type="radio" name="crf[<?php echo $v['id']; ?>]" value="">是&nbsp;&nbsp;<input type="radio" name="table-<?php echo $v['id']; ?>-<?php echo $table_k; ?>[]" value="">否</td>
										<?php
												}else{
												?>
												<td class="td_border"><input type="text" class="input-normal" name="crf[<?php echo $v['id']; ?>]" value=""></td>
