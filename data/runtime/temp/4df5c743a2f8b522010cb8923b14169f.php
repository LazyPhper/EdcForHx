<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:37:"themes/simpleboot3/portal\\index.html";i:1539085300;s:79:"E:\phpStudy\PHPTutorial\WWW\EdcForHx\public\themes\simpleboot3\public\head.html";i:1539085300;s:83:"E:\phpStudy\PHPTutorial\WWW\EdcForHx\public\themes\simpleboot3\public\function.html";i:1539085300;s:78:"E:\phpStudy\PHPTutorial\WWW\EdcForHx\public\themes\simpleboot3\public\nav.html";i:1539085300;s:81:"E:\phpStudy\PHPTutorial\WWW\EdcForHx\public\themes\simpleboot3\public\footer.html";i:1539085300;s:82:"E:\phpStudy\PHPTutorial\WWW\EdcForHx\public\themes\simpleboot3\public\scripts.html";i:1539085300;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<![endif]-->
<link rel="icon" href="/EdcForHx/public/themes/simpleboot3/public/assets/images/favicon.png" type="image/png">
<link rel="shortcut icon" href="/EdcForHx/public/themes/simpleboot3/public/assets/images/favicon.png" type="image/png">
<link href="/EdcForHx/public/themes/simpleboot3/public/assets/simpleboot3/themes/simpleboot3/bootstrap.min.css" rel="stylesheet">
<link href="/EdcForHx/public/themes/simpleboot3/public/assets/simpleboot3/font-awesome/4.4.0/css/font-awesome.min.css" rel="stylesheet"
      type="text/css">
<!--[if IE 7]>
<link rel="stylesheet" href="/EdcForHx/public/themes/simpleboot3/public/assets/simpleboot3/font-awesome/4.4.0/css/font-awesome-ie7.min.css">
<![endif]-->
<link href="/EdcForHx/public/themes/simpleboot3/public/assets/css/style.css" rel="stylesheet">
<style>
...
<script type="text/javascript">
    //全局变量
    var GV = {
        ROOT: "/EdcForHx/public/",
        WEB_ROOT: "/EdcForHx/public/",
        JS_ROOT: "static/js/"
    };
</script>
<script src="/EdcForHx/public/themes/simpleboot3/public/assets/js/jquery-1.10.2.min.js"></script>
<script src="/EdcForHx/public/themes/simpleboot3/public/assets/js/jquery-migrate-1.2.1.js"></script>
<script src="/EdcForHx/public/static/js/wind.js"></script>
	
    <link href="/EdcForHx/public/themes/simpleboot3/public/assets/css/slippry/slippry.css" rel="stylesheet">
    <style>
        .caption-wraper {
            position: absolute;
            left: 50%;
    ...
    <?php 
    \think\Hook::listen('before_head_end',$temp5bbcbb190eb46,null,false);
 ?>
</head>
...
<nav class="navbar navbar-default navbar-fixed-top active">
    <div class="container active">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/EdcForHx/public/"><?php echo (isset($theme_vars['company_name']) && ($theme_vars['company_name'] !== '')?$theme_vars['company_name']:'ThinkCMF'); ?></a>
        </div>
...
function __parse_navigatione85d8b3c09a5362e2e518bf397162164($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigatione85d8b3c09a5362e2e518bf397162164';
...
if(''==''): ?>
    <?php echo __parse_navigatione85d8b3c09a5362e2e518bf397162164($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigatione85d8b3c09a5362e2e518bf397162164($menus); ?>
    </>
<?php endif; ?>
                ...
                <li class="dropdown user login">
                    <a class="dropdown-toggle user" data-toggle="dropdown" href="#">
                        <?php $user=cmf_get_current_user(); if(empty($user['avatar'])): ?>
                            <img src="/EdcForHx/public/themes/simpleboot3/public/assets/images/headicon.png" class="headicon">
                            <?php else: ?>
...
if(count($__SLIDE_ITEMS__) == 0): ?>
        ...
        <li>
            ...
            <a href=""><img src="/EdcForHx/public/themes/simpleboot3/public/assets/images/demo/1.jpg" alt=""></a>
        </li>
        <li>
            <div class="caption-wraper">
                <div class="caption">此幻灯片只是演示,您没有设置任何幻灯片,请到后台模板设置！</div>
            </div>
            <a href=""><img src="/EdcForHx/public/themes/simpleboot3/public/assets/images/demo/2.jpg" alt=""></a>
        </li>
        <li>
            <div class="caption-wraper">
                <div class="caption">此幻灯片只是演示,您没有设置任何幻灯片,请到后台模板设置！</div>
            </div>
            <a href=""><img src="/EdcForHx/public/themes/simpleboot3/public/assets/images/demo/3.jpg" alt=""></a>
        </li>
...
<div class="container">
 ...
 ?>
        ...
        <?php 
         ...
         $__FOR_START_7564__=1;$__FOR_END_7564__=$rows;for($row=$__FOR_START_7564__;$row <= $__FOR_END_7564__;$row+=1){ 
                $first_row = ($row-1)*3;
                            ...
                            <div class="item-image">
                                <a href="<?php echo cmf_url('portal/Article/index',array('id'=>$vo['id'],'cid'=>$vo['category_id'])); ?>">
                                    <?php if(isset($vo['more']['thumbnail'])): if(empty($vo['more']['thumbnail']) || (($vo['more']['thumbnail'] instanceof \think\Collection || $vo['more']['thumbnail'] instanceof \think\Paginator ) && $vo['more']['thumbnail']->isEmpty())): ?>
                                            <img src="/EdcForHx/public/themes/simpleboot3/public/assets/images/default-thumbnail.png"
...
<div id="footer">
    <?php 
    \think\Hook::listen('footer_start',$temp5bbcbb190eb66,null,false);
 ?>
    <div class="links">
        <?php
...
<?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <p>
        ...
        <?php endif; if(!(empty($site_info['site_gwa']) || (($site_info['site_gwa'] instanceof \think\Collection || $site_info['site_gwa'] instanceof \think\Paginator ) && $site_info['site_gwa']->isEmpty()))): ?>
            <img src="/EdcForHx/public/themes/simpleboot3/public/assets/images/ghs.png">
...
<!-- Le javascript
    ...
    <script src="/EdcForHx/public/themes/simpleboot3/public/assets/simpleboot3/bootstrap/js/bootstrap.min.js"></script>
    <script src="/EdcForHx/public/static/js/frontend.js"></script>
	<script>
	$(function(){
...
<script src="/EdcForHx/public/themes/simpleboot3/public/assets/js/slippry.min.js"></script>
<script>
    $(function () {
        $("#home-slider").slippry({
            transition: 'fade',
...
<?php 
    \think\Hook::listen('before_body_end',$temp5bbcbb190eb7b,null,false);
 ?>
</body>
</html>
